    ...
    <section class="content">
        <div class="container">
            ...
            <div class="common-content product-area">
                <div class="col-lg-4 col-md-4 product-sidebar">
                    <div class="p-list">
                    ...
                    <div class="p-gal gal-link">
                        <h3><?php the_field('photo_glry_title');?></h3>
                        <div class="p-img-holder">
						<a href="<?php echo esc_url( get_permalink(96) ); ?>"><img class="img-responsive" src="<?php echo the_field('photo_glry') ?>" alt="gallery" />
						<span>Gallery</span>
						</a>
						</div>
                    </div>
				...
				<div class="product-btn">
                    <h1 class="product-main"><?php the_field('products_title');?></h1><a href="#"> </a> </div>
                    ...
                    <div class="product-item">
                        <div class="pro-img">
                          <a href="<?php the_permalink(); ?>"> <?php if ( has_post_thumbnail() ) 
							{
							the_post_thumbnail('product_outer');
							}
							else
							{
							?>
                    ...
                    <!--<div class="product-item">
                        <div class="pro-img">
                            <img src="<?php echo the_field('product2_img') ?>" alt="product2" class="img-responsive" /><span></span></div>
                        <h2><?php the_field('product2_title');?></h2>
                        <p><?php the_field('product_content1');?> </p>
                    </div>-->
                </div>
            </div>

...
<?php /* Template Name: product inner2 */ ?>
  <?php get_header(); ?>
        ...
        <div class="container">
            ...
            <div class="common-content product-area">
                <div class="col-lg-4 product-sidebar">
                    <div class="p-list">
                        <h3><?php the_field('product_title',14);?></h3>
                        <ul>
                            <li><a href="<?php echo esc_url( get_permalink(14) ); ?>"><?php the_field('product_sub_title',14);?></a></li>
                            <li><a href="<?php echo esc_url( get_permalink(16) ); ?>"><?php the_field('product_content',14);?></a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-8 product-inner">
                    <h1><?php the_field('hangar-door-systems_title');?></h1>
                    <p><?php the_field('hangar-door-systems_sub1');?></p>
                    <p><?php the_field('hangar-door-systems_sub2');?></p>
                    <p><?php the_field('hangar-door-systems_sub3');?></p>
                    <p><?php the_field('hangar-door-systems_sub4');?></p>
